...
- Moved the Claude Code plugin manifest to the family-level `skills/development/building-blocks/.claude-plugin/plugin.json`, matching the `scrolls-*` packaging model.
