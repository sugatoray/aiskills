...
select all five `scrolls-*` skills (or just `scrolls-hide`) at the prompt:
...
```
npx skills add sugatoray/aiskills --skill scrolls-hide --global   # global
npx skills add sugatoray/aiskills --skill scrolls-hide            # local
```
...
```
npx skills add sugatoray/aiskills --skill scrolls-hide --yes            # project
npx skills add sugatoray/aiskills --skill scrolls-hide --global --yes   # global
```
...
```
cd /path/to/aiskills
npx skills add . --skill scrolls-hide --yes
```
