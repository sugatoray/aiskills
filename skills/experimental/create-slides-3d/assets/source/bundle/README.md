...
The compiled source files are preserved for offline inspection of the reference application's rendering approach. The live source is https://ethical.institute/keynote/#D3. This archived bundle is not used by the reusable `create-slides-3d` engine.
